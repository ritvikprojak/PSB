package com.projak.psb.search.plugin;
 ...
 * <p>
 */
public class PSBSearchPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "PSBSearchPluginDojo.ConfigurationPane";
	}
	...
	/**
		...
		public PluginRequestFilter[] getRequestFilters() {
			if (pluginRequestFilters.length == 0) {
				pluginRequestFilters = new PluginRequestFilter[] {new com.projak.psb.search.plugin.filters.CustomSearchReqFilter()};
			}
		...
		public PluginAction[] getActions() {
			if (pluginActions.length == 0) {
				pluginActions = new PluginAction[] {new com.projak.psb.search.plugin.actions.CustomDownloadAction()};
			}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {/*new com.projak.psb.search.plugin.services.GetEmployeeService(),*/ new com.projak.psb.search.plugin.services.GetDocSecurityService(),new com.projak.psb.search.plugin.services.WatermarkService(),new com.projak.psb.search.plugin.services.DownloadAuditService()};
		}
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (pluginResponseFilters.length == 0) {
			pluginResponseFilters = new PluginResponseFilter[] {new com.projak.psb.search.plugin.filters.PSBResponseViewerFilter()};
		}
