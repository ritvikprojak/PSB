...
//				});
		...
		ReportsGeneration: function(){
			...
			this.inherited(arguments);
			console.log("in  onchange comboBox Name:::: ",self.comboBox.value);
			    ...
			    if (!isNaN(startDate) && !isNaN(endDate)) {
			        ...
			        if (startDate.getMonth() === endDate.getMonth()) {
			            ...
			            if (
			                ...
			                alert("Start date should be the 1st of the month, and end date should be the last day of the same month or the last day of the current month.");
			            }
			        } else {
			            alert("Start date and end date should be from the same month.");
			        }
			    } else {
