 ...
 */
public class DatacapReportDBCheckService extends PluginService {
	 ...
	 */
	public String getId() {
		return "DatacapReportDBCheckService";
	}
	...
	public void execute(PluginServiceCallbacks callbacks,
			...
			throws Exception {
		System.out.println("<<< ::: In the DatacapReportDBCheckService ::: >>>");
	    ...
	    try {
            ...
            connection = util.getDatacapDBConnection(repoID);
            
	        System.out.println("Database Schema Name:: " + connection.getSchema());
	        JSONObject jsonObject =  util.retrieveDataFromDatacapTable(connection,date,date4,repoID,reportName);
