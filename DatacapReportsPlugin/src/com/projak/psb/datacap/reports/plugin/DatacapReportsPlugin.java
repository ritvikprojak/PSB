package com.projak.psb.datacap.reports.plugin;
 ...
 * <p>
 */
public class DatacapReportsPlugin extends Plugin {
	...
	public String getScript() {
		return "DatacapReportsPlugin.js";
	}
	...
	public String getDojoModule() {
		return "datacapReportsPluginDojo";
	}
	...
	public String getCSSFileName() {
		return "DatacapReportsPlugin.css";
	}
	...
	public String getConfigurationDijitClass() {
		return "datacapReportsPluginDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public PluginFeature[] getFeatures() {
	    	if (pluginFeatures.length == 0) {
				pluginFeatures = new PluginFeature[] {new com.projak.psb.datacap.reports.plugin.features.DatacapReports()};
			}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {
					new com.projak.psb.datacap.reports.plugin.services.DatacapReportDBCheckService(), 
					new com.projak.psb.datacap.reports.plugin.services.DatacapReportGenerateService(), 
					new com.projak.psb.datacap.reports.plugin.services.GetEmployeeDetailsService(), 
					new com.projak.psb.datacap.reports.plugin.services.UserDBReportCheckService(), 
					new com.projak.psb.datacap.reports.plugin.services.UserDBReportGenerateService()
					};
		}
