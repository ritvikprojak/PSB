...
import com.projak.psb.datacap.reports.plugin.utils.DBOperationsUtil;
...
public class UserDBReportCheckService extends PluginService {
	...
	public void execute(PluginServiceCallbacks callbacks,
	    ...
	    try {
	        ...
	        JSONObject jsonObject =  util.retrieveDataFromTable(connection,date,date4,repoID,reportName);
