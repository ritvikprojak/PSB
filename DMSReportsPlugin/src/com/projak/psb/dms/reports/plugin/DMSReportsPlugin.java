package com.projak.psb.dms.reports.plugin;
 ...
 * <p>
 */
public class DMSReportsPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "dMSReportsPluginDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public PluginFeature[] getFeatures() {
	    	if (pluginFeatures.length == 0) {
				pluginFeatures = new PluginFeature[] {new com.projak.psb.dms.reports.plugin.features.DMSReports()};
			}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {
					new com.projak.psb.dms.reports.plugin.services.AuditDBService(),
					new com.projak.psb.dms.reports.plugin.services.GetEmployeeDetailsService(),
					new com.projak.psb.dms.reports.plugin.services.UserDBReportCheckService(),
					new com.projak.psb.dms.reports.plugin.services.UserDBReportGenerateService(),
					new com.projak.psb.dms.reports.plugin.services.UserLoginDBService(),
					new com.projak.psb.dms.reports.plugin.services.UserLogoffDBService()
					};
		}
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (pluginResponseFilters.length == 0) {
			pluginResponseFilters = new PluginResponseFilter[] {
					new com.projak.psb.dms.reports.plugin.filters.CheckInAuditResponseFilter(), 
					new com.projak.psb.dms.reports.plugin.filters.DeleteAuditResponseFilter(), 
					new com.projak.psb.dms.reports.plugin.filters.EditAttributesAuditResponseFilter(), 
					new com.projak.psb.dms.reports.plugin.filters.SearchAuditResponseFilter()};
		}
