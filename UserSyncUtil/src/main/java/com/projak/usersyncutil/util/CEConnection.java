...
public class CEConnection {
	...
	public Connection establishConnection()
    {
		...
		try {
			String uri = PropertyReader.getProperty("ce.uri");
			
			System.out.println("uri:"+uri);
			
			con = Factory.Connection.getConnection(uri);
        
			String userName = PropertyReader.getProperty("ce.username");
        
			String password = PropertyReader.getProperty("ce.password");
